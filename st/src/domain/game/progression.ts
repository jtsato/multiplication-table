...
export const CHAPTERS: Chapter[] = [
  ...
  { number: 2, title: "Mais ideias na prateleira", requiredDay: 3, visualChange: "prateleira lateral" },
  { number: 3, title: "A loja ganha espaço", requiredDay: 7, visualChange: "área de exposição" },
  { number: 4, title: "Uma loja cheia de histórias", requiredDay: 12, visualChange: "fachada iluminada" },
];
