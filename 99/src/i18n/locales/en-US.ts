...
export const enUS: LocaleDefinition = {
  strings: {
    ...
    duskWarning: 'Getting dark — light your lantern at the campfire ({{s}}s)',
     ...
     plantSeedPrompt: 'Press E to plant',
    ...
    buildOffLand: 'Too far — build on solid ground',
     ...
     spotPrompt: 'Press E to use: {{movel}}',
    ...
    controlsSolve: 'E — solve and gather · 1 2 3 — answer',
     controlsBuild: 'B — campfire · C — fence · G — garden bed · L — shop',
     controlsPlant: 'G — plant bed · T/F — plant tree',
     ...
     plantFruitTree: 'Plant fruit tree',
    ...
    mirrorTitle: 'Mirror',
     ...
     chartProgress: '{{known}} of {{total}}',
     chartCell: '{{a}} times {{b}} is {{answer}}',
     chartCellKnown: '{{a}} times {{b}} is {{answer}}, you already know it',
